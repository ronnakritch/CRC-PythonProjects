...
for row in data:
    ...
    check_query = text("""
    SELECT 1 FROM check_report_checklist
    ...
    if exists:
        ...
        insert_query = text("""
        INSERT INTO check_report_checklist (bu, stcode, branch, shub, type1, cntdate, status)
