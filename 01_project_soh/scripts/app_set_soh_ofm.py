...
from configs.parameter_soh_jda import OFM_parameter  # importing parameters

user_name = OFM_parameter["user"]
pass_word = OFM_parameter["pass"]
...
time.sleep(1)
pyautogui.write('27') #Data Management
time.sleep(1)
pyautogui.write('17') #Generated 27
...
pyautogui.press('delete') #del date text step1
pyautogui.press('delete') #del date text step2
